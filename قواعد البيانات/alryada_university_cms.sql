...
(1, ' جامعة الريادة', 'About Al-Riyada Universit', 'المعرفة، الابتكار، المستقبل', 'Knowledge, Innovation, Future', '/image/g1.jpg', '2025-05-11 20:12:47', '2025-07-13 00:38:29');
...
(4, 1, 'video', 'https://youtu.be/7Dy8ymLWeU0?si=k9uhXMWjKf7xAoT6', 'فيديو تعريفي بالمؤتمر', 'Conference Introduction Video', NULL, NULL, 0, 4, '2025-07-06 14:04:28', '2025-07-11 20:55:50'),
...
(8, 2, 'video', 'https://youtu.be/7Dy8ymLWeU0?si=k9uhXMWjKf7xAoT6', 'فيديو تعريفي بالمعرض', 'Exhibition Introduction Video', NULL, NULL, 0, 4, '2025-07-06 14:04:28', '2025-07-11 20:56:25');
...
(1, 'كلية الهندسة وتقنية المعلومات', 'College of Engineering', 'نحو مستقبل هندسي وبرمجي أفضل', 'Towards a better engineering & programmg future', '/colloge/3.jpg', 'تأسست كلية الهندسة في جامعة الريادة لتكون منارة للتعليم الهندسي المتميز. نسعى لتخريج مهندسين أكفاء قادرين على المساهمة في تطوير القطاع الهندسي والتكنولوجي في المجتمع.', 'The College of Engineering at Al-Riyada University was established to be a beacon of distinguished engineering education. We aim to graduate competent engineers capable of contributing to the development of the engineering and technological sector in society.', 'أ.د. احمد عبدة', 'Prof. Ahmed Abdu', 'عميد كلية الهندسة', 'Dean of the College of Engineering', '/deans/1737840705873.jpg', 'نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي نص تجريبي.', 'Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text Experimental Text  ', '2025-07-13 03:25:17'),
...
(1, '  مستقبلك يبدأ هنا', 'Your Future Starts Here', 'إكتشف عالماً من الفرص التعليمية الاستثنائية في جامعتنا', 'Discover a world of exceptional educational opportunities at our university', '/image/a1.jpg', 'المزيد', 'Discover More', '#', 1, 1, '2025-05-11 17:57:50', '2025-07-11 21:21:14'),
(2, 'التميز في البحث العلمي', 'Excellence in Scientific Research', 'نقود مسيرة البحث العلمي نحو آفاق جديدة', 'Leading the way in scientific research towards new horizons', '/image/g2.jpg', 'اكتشف المزيد', 'Discover More', '/about', 3, 1, '2025-05-11 17:57:50', '2025-07-11 19:43:38'),
(3, 'بيئة تعليمية متكاملة', 'Integrated Educational Environment', 'نحن نوفر أحدث التقنيات والمرافق لطلابنا', 'We provide the latest technologies and facilities for our students', '/image/g1.jpg', 'اكتشف ', 'Discover', '#', 2, 1, '2025-05-11 17:57:50', '2025-07-11 21:21:44');
...
(11, 'Architecture', 'معمارية', 'Engineering College', 'كلية الهندسة', 'engineering', 'Architecture', 'Design and planning of architectural buildings and structures', 'تصميم وتخطيط المباني والمنشآت المعمارية', '🏛️', 'Bachelor - 5 years', 180, '[\"Architectural Design\", \"Urban Planning\", \"Modern Building Techniques\"]', '[\"تصميم معماري\", \"تخطيط عمراني\", \"تقنيات البناء الحديثة\"]', '[\"High school diploma with a minimum average of 80%\", \"Pass the engineering aptitude test\", \"Pass the personal interview\", \"Proficiency in engineering drawing skills\"]', '[\"الحصول على شهادة الثانوية العامة بمعدل لا يقل عن 80%\", \"اجتياز اختبار القدرات الهندسية\", \"اجتياز المقابلة الشخصية\", \"إتقان مهارات الرسم الهندسي\"]'),
(12, 'Information Technology', 'تقنية المعلومات', 'Engineering College', 'كلية الهندسة', 'engineering', 'IT', 'Development and management of IT systems', 'تطوير وإدارة أنظمة تكنولوجيا المعلومات', '💻', 'Bachelor - 4 years', 250, '[\"Computer Programming\", \"Computer Networks\", \"Information Security\"]', '[\"برمجة الحاسوب\", \"شبكات الحاسوب\", \"أمن المعلومات\"]', '[\"High school diploma with a minimum average of 70%\", \"Pass the math aptitude test\", \"Basic knowledge of computers and programming\", \"Pass the personal interview\"]', '[\"الحصول على شهادة الثانوية العامة بمعدل لا يقل عن 70%\", \"اجتياز اختبار القدرات في الرياضيات\", \"إلمام بأساسيات الحاسوب والبرمجة\", \"اجتياز المقابلة الشخصية\"]'),
...
(11, 'المساعد الذكي', 'smart bot ', '#', 4, 1, 'global', NULL);
...
(1, 'بدء التسجيل للفصل الدراسي الجديد', 'Scientific Conference on Latest Research Developments', 'فتح باب التسجيل للطلاب الجدد والمستمرين', 'Researchers present latest findings in various fields', '<p>أعلنت عمادة القبول والتسجيل عن بدء استقبال طلبات التسجيل للفصل الدراسي الأول من العام الجامعي 1447/1448هـ اعتباراً من يوم الأحد القادم.</p><p>وأوضح عميد القبول والتسجيل الدكتور فهد السليم أن التسجيل سيكون متاحاً عبر البوابة الإلكترونية للجامعة، مشيراً إلى ضرورة الالتزام بالمواعيد المحددة لكل كلية وتخصص.</p><p>كما أكد على أهمية استكمال جميع المتطلبات والوثائق المطلوبة قبل التقديم لضمان سرعة إنجاز الطلبات وتفادي أي تأخير في عملية التسجيل.</p>', '<p>The university signed a cooperation agreement with several international universities to exchange experiences and develop academic programs. This agreement aims to enhance the quality of education and provide new opportunities for students and faculty members.</p><p>The agreement includes student and faculty exchange programs, joint research projects, and the development of educational curricula. It also includes organizing joint conferences and workshops.</p><p>This agreement is part of the university\'s strategy to enhance its global presence and provide distinguished educational opportunities for its students.</p>', 'أعلنت عمادة القبول والتسجيل عن بدء استقبال طلبات التسجيل للفصل الدراسي الجديد عبر البوابة الإلكترونية للجامعة', 'The university signed a cooperation agreement with several international universities to exchange experiences and develop academic programs.', '/image/a1.jpg', '2025-06-08 01:37:16', '2025-05-17 09:15:00', 2, 2, 128, 1, 1, 2, 'new-semester-registration', 'تسجيل,قبول,طلاب جدد,فصل دراسي', 'cooperation, international universities, academic programs, exchange'),
(3, 'جامعة الريادة تقيم حفل تدشين الدراسة واستقبال طلاب المستوى الأول بجامعة الريادة للعام الجامعي 2024/2025\r\n\r\n', 'Workshop on Developing Teaching Skills for Faculty Members', 'إنجاز جديد يضاف لسجل الجامعة الحافل', 'Developing teaching methods and enhancing educational outcomes', 'في أجواء من الحماس والتطلع إلى المستقبل، شهدت جامعة الريادة انطلاقة عامها الجامعي الجديد 2024/2025 باستقبال دفعة جديدة من الطلاب الواعدين، للإسهام في بناء المجتمع وازدهاره. حيث احتفلت الجامعة بهذه المناسبة بتنظيم لقاء موسع بجميع للطلاب تم خلاله الترحيب بالطلاب الجدد وتقديم لمحة عامة عن الدراسة الجامعية والفرص المتاحة لهم خلال مسيرتهم الجامعية. \r\n\r\nوفي كلمتها عبرت الأستاذة الدكتورة نهلة صالح الكعكي عن سعادتها باختيار هؤلاء الطلاب لجامعة الريادة؛ لتحقيق طموحاتهم المستقبلية، وأشارت في كلمتها إلى مساعي جامعة الريادة لتحقيق الجودة في التعليم الجامعي وتطويره وفق رؤيتها المستقبلية، التي تهتم بتحسين مخرجات الجامعة؛ لإيجاد كوادر وطنية مؤهلة، ينطلقون في سوق العمل ويمثلون سفراء لهذه الجامعة. \r\n\r\nومن جانبه رحب الدكتور سالم عبود غانم نائب رئيس الجامعة بالطلاب الجدد مبينًا لهم أهمية استشعار طبيعة المرحلة التعليمية التي انتقلوا إليها، مشيرًا إلى مساعي جامعة الريادة الحثيثة في رعاية طلابها والاهتمام بهم وتذليل كل الصعوبات أمامهم نحو بناء مستقبل لغدٍ مشرق في حياتهم العلمية والعملية، داعيًا الجميع إلى بذل الجهود للرقي بجامعة الريادة نحو الريادة في كل مجالاتها.\r\n\r\nومن جانبهم ألقى الأساتذة عمداء الكليات: الأستاذ الدكتور أحمد عبده عميد كلية الهندسة وتقنية المعلومات، والدكتور محمد الطالبي عميد كلية العلوم الإدارية، والدكتورة فاطمة عبادل عميد كلية الطب والعلوم الصحية كلماتٍ رحبوا فيها بالطلاب مشيرين إلى جهود الجامعة المستمرة في تطوير وتحديث برامجها الأكاديمية في ظل التطورات التكنولوجية الحديثة للرقي بطالب الجامعة إلى أعلى المراتب العلمية والمهنية.\r\n\r\nوفي السياق نفسه أشارت الأستاذة وئام سيف مسجل عام الجامعة في كلمتها إلى أهمية التزام الطلاب باللوائح والنظم المتبعة في الجامعة، مؤكدة دور إدارة القبول والتسجيل في رعاية الطلاب وشؤونهم الطلابية التي تضمن لطلاب الريادة كل حقوقهم المتعلقة بملفاتهم وسجلهم الأكاديمي والوثائق الرسمية التي يحتاجونها خلال فترة دراستهم بالجامعة. \r\n\r\nهذا وأكد الجميع في كلماتهم على أهمية الجد والاجتهاد والتميز في التحصيل العلمي، متمنين للجميع عامًا جامعيًا حافلًا بالعطاء والنجاح.\r\n', '<p>The university celebrated the graduation of a new batch of students from various colleges. The ceremony was attended by university officials, faculty members, students\' families, and a number of distinguished guests.</p><p>During the ceremony, outstanding students were honored, and graduation certificates were distributed to all graduates. The university president delivered a speech congratulating the graduates and wishing them success in their future careers.</p><p>The ceremony included various artistic and cultural performances that reflected the university\'s cultural diversity and its interest in developing students\' talents.</p>', 'في أجواء من الحماس والتطلع إلى المستقبل، شهدت جامعة الريادة انطلاقة عامها الجامعي الجديد 2024/2025 باستقبال دفعة جديدة من الطلاب الواعدين، للإسهام في بناء المجتمع وازدهاره.', 'The university celebrated the graduation of a new batch of students from various colleges with the presence of officials and families.', '/image/g7.jpg', '2025-06-12 01:37:16', '2025-05-18 14:45:00', 3, 1, 457, 1, 1, 3, 'innovation-competition-win', 'استقبال,فعالية,جامعة الريادة ', 'graduation, ceremony, students, achievement');
...
(4, 1, 'image', '', '', 'فريق كلية الهندسة الفائز بالمركز الأول', 'Students participating in community service activities and volunteer work', 1, 1200, 800, NULL, 1),
(5, 1, 'image', '', '', 'المشروع الفائز في مسابقة الابتكار', 'Workshop activities and interactive discussions between participants', 2, 1200, 800, NULL, 1);
...
(1, 'رسالة الجامعة', 'إعداد كوادر مؤهلة في مختلف التخصصات، وتقديم برامج علمية عالية الجودة متوافقة مع متطلبات التنمية واحتياجات سوق العمل ضمن بيئة تعليمية محفزة على الإبداع والتميز وتطوير الشراكات مع الجامعات والمؤسسات العلمية والهيئات المتميزة عالمياً.', 'ar', '2025-07-05 13:51:13', '2025-07-11 00:17:42'),
